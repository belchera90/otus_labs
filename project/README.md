...
Не получилось внедрить протокол bfd. При его использовании начиналось "дрожание" линков. Скорее всего, это связано с тем, что проект настраивался на эмуляторе eve-ng.
Так же не удалось применить Access lists для разграничения доступа клиентов сетей из CON_VRF2(ДМЗ) к клиентам сетей CON_VRF1. Это так же связано с тем, что проект настраивался на эмуляторе eve-ng.

 ![access.png](images/access.jpg)

## Выводы: 

В результате работы спроектирована и реализована современная распределенная L3 сеть ЦОД, отвечающая требованиям масштабируемости, безопасности и мультитенантности. Полученные результаты могут служить основой для дальнейших исследований и внедрения в реальных проектах.
