...
- Организовать контролируемое взаимодействие между фабриками
...
- Не удалось применить Access lists для разграничения доступа клиентов сетей из CON_VRF2(ДМЗ) к клиентам сетей CON_VRF1.
...
- объединение нескольких площадок в распределённого ЦОД;
