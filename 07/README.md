...
Далее проверим, что все необходимые маршруты 2 типа EVPN присутствуют в нашей фабрике. Это нужно, чтобы убедится в корректной работе нашей VxLAN+EVPN фабрики.</br>
 <details>
