...
клиенты находились в разных L2 сегментах(VLAN), но при этом могли обмениваться траффиком с клиентами из другого VLAN. Просто так покинуть VNI мы не можем - для этого нам нужна маршрутизация, которая в EVPN носит название "Integrated Routing and Bridging".
